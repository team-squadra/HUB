                    ...
                    <div class="col-12 h-100">
                        <div class="header-content h-100 d-flex align-items-center justify-content-between">
                            <div class="academy-logo">
                                ...
                                <table>
                                    <tr>
                                        <td style="padding: 10px;"><img src="../images/logopng.png" alt="" style="width: 40px;height: 40px;"></td>
                                        <td style="padding: 10px;"><strong style="font-size:30px;color: #6A41ED ">The Hub</strong></td>
                                    </tr>
